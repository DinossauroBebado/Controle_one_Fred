...
m = 5.571;     % MASSA DO ROBO
r_d = 0.15/2;      % RAIO DA RODA DIREITA
r_e = 0.15/2;      % RAIO DA RODA ESQUERDA
d = 0.3;         % DIMENSÃO ROBO
K_d = 0.5548;  % CONSTANTE DE TORQUE MOTOR DIREITO
K_e = 0.5548;  % CONSTANTE DE TORQUE MOTOR ESQUERDO
J_d = 0.0016;  % MOMENTO DE INERCIA DO ACOPLAMENTO RODA/MOTOR DIREITO
J_e = 0.0016;  % MOMENTO DE INERCIA DO ACOPLAMENTO RODA/MOTOR ESQUERDO
B_d = 4.78*10^-6; % COEFICIENTE DE ATRITO DO MOTOR DIREITO
B_e = 4.78*10^-6; % COEFICIENTE DE ATRITO DO MOTOR ESQUERDO
p_d = 2;      % RESISTIVIDADE ELETRICA MOTOR DIREITO
p_e = 2;      % RESISTIVIDADE ELETRICA MOTOR ESQUERDO
J = m*power(2*d,2)/3  % MOMENTO DE INERCIA ROBO
